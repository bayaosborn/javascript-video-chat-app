# How to Build a Javascript Video Chat App [Using CometChat Chat Widget]

Read the full tutorial here: [**>> How to Build a Javascript Video Chat App [Using CometChat Chat Widget]**](https://www.cometchat.com/tutorials/#)
...
7. Download the repository [here](https://github.com/hieptlccc/javascript-video-chat-app/archive/main.zip) or by running `git clone https://github.com/hieptlccc/javascript-video-chat-app.git` and open it in a code editor.
...
Questions about running the demo? [Open an issue](https://github.com/hieptlccc/javascript-video-chat-app/issues). We're here to help ✌️
